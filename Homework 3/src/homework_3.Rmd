...
load("C:/Users/ckell/OneDrive/Penn State/2017-2018/597/spatial_statistics_597/Homework 3/data/mcmc_data.RData")
## Diagnostics
...
I ran the Gibbs Sampler for the B=10,000 iterations and chose a burnin value of 1,000. After discarding the burnin, I include the trace and ACF plots for $\sigma^2$ and $\tau^2$ below. 
...
acf(t2.final)
```
Below, I also include a table with posterior means of the $\beta$'s and 95% credible intervals constructed using the 0.025 and 0.975 quantiles of the posterior samples

```{r, echo=FALSE, warning=FALSE,message=FALSE}
print(est_and_ci)
```
Lastly, I include a color map of the posterior means for the vector $\eta$ as well as a map for the posterior standard deviations for the vector $\eta$.
